...
List<plant_list> cart_lists =[
  ...
  plant_list(id: 'c1',img:'assest/images/plant2.png',Name: 'Monstera', price: '\$39'),
  plant_list(id: 'c2',img:'assest/images/plant3.png',Name: 'Ageratum', price: '\$18'),
  plant_list(id: 'c3',img:'assest/images/plant4.png',Name: 'gester', price: '\$40'),
        ...
        child: Container(
          ...
          child: Column(
              children: [
                ...
                top: 5),
                    child: Text(cart2.price,  style:const TextStyle(
                        fontWeight: FontWeight.bold ))),
              Container(
                padding: EdgeInsets.only(top: 25),
                  child: Image(image: AssetImage(cart2.img),height: 200,)
              ),
                Text(cart2.Name,style: const TextStyle (
                    fontWeight: FontWeight.bold )),
